...
* Candidate info dataset is a modified dataset based off [Split Ticket's](https://www.theargumentmag.com/p/split-ticket-2026-midterms-model) model output dataset. I do not utilize Split Ticket's model output in my model.
...
* Pollster ratings from [The Silver Bulletin](https://www.natesilver.net/p/pollster-ratings-silver-bulletin).
