...
* Past House, Senate, and state-level presidential election results from [MIT Election Lab](https://electionlab.mit.edu/data#data).
* Fundraising data from the [Federal Election Commission](https://www.fec.gov/data/browse-data/?tab=bulk-data).
...
* District- and state-level racial, educational, income, and urban/rural demographic data from [Redistricting Data Hub](https://redistrictingdatahub.org/), the [US Census Bureau](https://www.census.gov/programs-surveys/decennial-census/about/voting-rights/cvap/2020-2024-CVAP.html), and The Downballot.
* Polls from FiveThirtyEight and the Silver Bulletin. 2014 pollster ratings from FiveThirtyEight.
